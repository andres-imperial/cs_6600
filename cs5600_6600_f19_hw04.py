...
def getBeeTrainingData():
    beeImages = loadBeeImages(
        "/home/aimperial/School/cs_6600/project_1/data/BEE1/bee_train/img0/")
...
def testTrain():
    ...
    myNet = network2.Network([1024, 32, 2], QuadraticCost)
    ...
    print(type(train_d[0][0]))
    print(train_d[0][0].shape)
    print(type(trainData[0][1]))
    print(trainData[0][1].shape)
    print(type(train_d[0][1]))
    print(train_d[0][1].shape)
    net_stats = myNet.SGD(trainData, 1, 46, 10, 0.1,
                          evaluation_data=valid_d,
                          monitor_evaluation_cost=False,
                          monitor_evaluation_accuracy=False,
                          monitor_training_cost=True,
